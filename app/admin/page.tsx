    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center py-12 px-4 relative overflow-hidden">
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl" style={{ animation: 'floatA 13s ease-in-out infinite', willChange: 'transform' }} />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl" style={{ animation: 'floatB 16s ease-in-out 1s infinite', willChange: 'transform' }} />
        </div>
